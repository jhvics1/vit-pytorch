...
class LARS(Optimizer):
    ...
    Wraps an arbitrary optimizers like :class:`torch.optim.SGD` to use LARS. If
    ...
    Example::
        ...
        optimizers = LARS(optimizers=base_optimizer)
        output = model(input)
    ...
    def step(self, *args, **kwargs):
        ...
        loss = self.optim.step(*args, **kwargs)  # Normal optimizers
